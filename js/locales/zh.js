...
export const zh = {
    ...
    ui_static: {
        ...
        modals: {
            ...
            confirm: '确定',
            about_us_title: '关于我们',
            about_us_desc1: '你好，我是一名前大厂游戏开发员工。在互联网狂飙多年后，我深刻体会到了这个行业的魅力与残酷。在这个充满梦想与高薪神话的行业里，有时候依然难以抵挡一纸裁员通知，那条隐形的“斩杀线”随时可能落下。',
            about_us_desc2: '目前我正在探索 Vibe Coding 的可能性，《斩杀线生存》正是我的一次尝试，希望能让你感受到生存的困境与黑色幽默。如果有任何问题或建议，欢迎联系我探讨！',
            contact_info: '联系方式: killzone-survivor@foxmail.com',
    ...
    manual: {
        ...
        sections: [
            ...
            },
            {
                ...
                list: [
                    '`白天`：处理工作相关事件，并完成当日的"午餐/额外行动/突发"选择。',
            ...
            },
            {
                ...
                subsections: [
                    ...
                    },
                    {
                        ...
                        note: '建议：在不熟悉版本节奏前，先把保留现金设高一点，避免被自动还款抽干现金导致第二天无法吃饭。'
                    }
                ]
            },
            {
